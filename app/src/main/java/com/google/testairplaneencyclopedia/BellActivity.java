...
public class BellActivity extends AppCompatActivity {
    ...
    Button bell47;     Button bell429;
    Button bell47j;    Button bell430;
    Button bell204;    Button bell525;
    Button bell206;    Button bell_h12;
    Button bell212;    Button bell_h13;
    Button bell214;    Button bell_xh15;
    Button bell214st;  Button bell_hsl;
    Button bell222;    Button bell_uh1;
    Button bell407;    Button bell207;
    Button bell412;    Button bell_ah1cobra;
    Button bell427;    Button bell_ah1supercobra;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      bell47 = (Button) findViewById(R.id.bell47);        bell429 = (Button) findViewById(R.id.bell429);
      bell47j = (Button) findViewById(R.id.bell47j);      bell430 = (Button) findViewById(R.id.bell430);
      bell204 = (Button) findViewById(R.id.bell204);      bell525 = (Button) findViewById(R.id.bell525);
      bell206 = (Button) findViewById(R.id.bell206);      bell_h12 = (Button) findViewById(R.id.bell_h12);
      bell212 = (Button) findViewById(R.id.bell212);      bell_h13 = (Button) findViewById(R.id.bell_h13);
      bell214 = (Button) findViewById(R.id.bell214);      bell_xh15 = (Button) findViewById(R.id.bell_xh15);
      bell214st = (Button) findViewById(R.id.bell214st);  bell_hsl = (Button) findViewById(R.id.bell_hsl);
      bell222 = (Button) findViewById(R.id.bell222);      bell_uh1 = (Button) findViewById(R.id.bell_uh1);
      bell407 = (Button) findViewById(R.id.bell407);      bell207 = (Button) findViewById(R.id.bell207);
      bell412 = (Button) findViewById(R.id.bell412);      bell_ah1cobra = (Button) findViewById(R.id.bell_ah1cobra);
      bell427 = (Button) findViewById(R.id.bell427);      bell_ah1supercobra = (Button) findViewById(R.id.bell_ah1supercobra);
